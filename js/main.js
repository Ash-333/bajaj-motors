...
class BajajApp {
    ...
    getStatus() {
        return {
            ...
            carouselStats: this.carouselManager ? this.carouselManager.getStats() : null,
            currentCategory: this.navbarManager ? this.navbarManager.getCurrentCategory() : null
        };
    }
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.testCarousel = function() {
        ...
        console.log('New slide added. Current stats:', app.getCarouselManager().getStats());
    };
